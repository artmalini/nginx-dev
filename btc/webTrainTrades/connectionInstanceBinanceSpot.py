...
TESTNET_WEBSOCKET_BINANCE = "binance.com-testnet"
MAINNET_WEBSOCKET_BINANCE = "binance.com"

TESTNET_BINANCE = "binance.com-testnet"
MAINNET_BINANCE = "binance.com"

class ConnectionInstanceBinanceSpot:
    ...
    def processBinance(self):
        if 'BINANCE-SPOT' in self.config['EXCHANGES']:
            if self.config['EXCHANGES']['BINANCE-SPOT']['ENABLED']:
            ...
            if self.testnet == True :
                self.api_key = self.config['EXCHANGES']['BINANCE-SPOT']['TEST']['API_KEY']
                self.api_secret = self.config['EXCHANGES']['BINANCE-SPOT']['TEST']['API_SECRET']
            ...
            if self.testnet == False :
                self.api_key = self.config['EXCHANGES']['BINANCE-SPOT']['PROD']['API_KEY']
                self.api_secret = self.config['EXCHANGES']['BINANCE-SPOT']['PROD']['API_SECRET']
